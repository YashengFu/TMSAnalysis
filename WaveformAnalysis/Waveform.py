			...
			for i,e in enumerate(np.argsort(self.ix_channel)):
					...
					if 'SiPM' not in self.waveform[v].detector_type:
						...
						if not FFT:
							...
							plt.text(190,ch_offset*i,'{} {:.1f}'.format(v,baseline_rms))					
